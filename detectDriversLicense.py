...
def getDriversLicense(image):

  # img = cv2.imread(image) # input_fileは画像のパス
  ...
  tree = ET.parse("/var/www/html/recognition/static/configImg/driversLicense.xml") # input_xmlはxmlのパス
  root = tree.getroot()
